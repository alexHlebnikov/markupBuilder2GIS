...
module.exports = function() {
    ...
    if (projectConfig.useSVG) {
                ...
                spritesmith(
                    {
                        ...
                        cssTemplate: './markup/static/less/spriteGeneratorTemplates/less.svgFallbackSprite.mustache'
                    }
                )
            )
        ...
        return spriteData.css.pipe(gulp.dest('./markup/static/less/spritesLess/'))
